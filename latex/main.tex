\documentclass[twoside,12pt,openright]{report} % IL setup attuale è doppia faccia
...
\include{Capitoli/Frontespizio_Merca}
...
% \include{Capitoli/Conclusion}
\include{Capitoli/Thanks}
